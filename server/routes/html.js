...
module.exports = () => {
  ...
  <head>
    ...
    <% if (assets.version) { %><link rel="stylesheet" type="text/css" href="//0182624d.ngrok.io/app/auth0-logs-to-mixpanel.ui.<%= assets.version %>.css" /><% } %>
  ...
  <body>
    ...
    <% if (assets.version) { %>
    <script type="text/javascript" src="//0182624d.ngrok.io/app/auth0-logs-to-mixpanel.ui.vendors.<%= assets.version %>.js"></script>
    <script type="text/javascript" src="//0182624d.ngrok.io/app/auth0-logs-to-mixpanel.ui.<%= assets.version %>.js"></script>
    <% } %>
  </body>
  </html>
  `;
